...
export default function LegalHelp() {
  return (
    <div className="w-full overflow-hidden bg-linear-to-b from-[#f0f9ff] via-[#ecfeff] to-white text-gray-800 relative">
      <style>{`
        .kenburns { transform-origin: center; animation: khKb 20s ease-in-out infinite alternate; }
      ...
      <header className="relative z-10">
        <div className="min-h-[72vh] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center px-6 py-20 relative z-10">
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-700 via-sky-600 to-teal-500">
        ...
        >
          {slides.map((s) => (
            <SwiperSlide key={s.id}>
              ...
              >
                <img src={s.img} alt={s.title} className="w-full h-full object-cover kenburns" />
                <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/10 to-transparent" />
                <div className="absolute left-8 bottom-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 max-w-md">
                  <h3 className="text-2xl font-semibold text-white">{s.title}</h3>
                  <p className="text-gray-100 text-sm mt-2">{s.desc}</p>
                </div>
              </motion.div>
            </SwiperSlide>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex flex-col md:flex-row gap-4 items-stretch">
              <div className="md:w-1/3 flex items-center justify-center bg-linear-to-br from-sky-50 to-blue-100 rounded-lg p-4">
      ...
      {/* CTA */}
      <section className="py-12 bg-linear-to-r from-sky-50 to-blue-100">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h4 className="text-2xl font-bold text-blue-800">Support Nari Nyay</h4>
          ...
          <div className="flex gap-3">
            <a
              href="/donate"
              className="inline-block px-6 py-3 rounded-full bg-linear-to-r from-blue-600 to-sky-500 text-white font-semibold shadow hover:brightness-95 transition"
            >
              Donate
            </a>
            <a
              href="/volunteer"
              className="inline-block px-6 py-3 rounded-full border border-blue-600 text-blue-700 font-semibold bg-white hover:bg-blue-50 transition"
            >
              Volunteer / Partner
            </a>
          </div>
